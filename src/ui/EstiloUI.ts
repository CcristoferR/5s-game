...
/**
 * Botón de los paneles de un turno de guardia.
 *
 ...
 *
 * Nació en el libro del condominio y vive aquí desde que el supermercado
 * necesitó los mismos paneles: dos escenarios del mismo curso no pueden tener
 * botones distintos.
 */
export function crearBotonTurno(
  nombre: string,
  texto: string,
  ancho: number,
